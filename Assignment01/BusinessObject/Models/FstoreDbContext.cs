...
public partial class FstoreDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B2E9BA2F7");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__Member__0CF04B18197F6C2F");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BCF9AB58D56");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId }).HasName("PK__OrderDet__08D097A30983CF88");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6CDEC3ED075");
